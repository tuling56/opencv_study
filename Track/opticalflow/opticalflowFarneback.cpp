...
// Source : http://blog.csdn.net/zouxy09/article/details/8683859
...
int opticalflowFarneback_main()
{
	...
	for(;;)
	{
		double t = (double)cvGetTickCount(); //the time processing one frame

		cap >> frame;
		cvtColor(frame, gray, CV_BGR2GRAY);
		imshow("original", frame);
		//prevgray=gray; //×Ô¼ºÌí¼Ó
